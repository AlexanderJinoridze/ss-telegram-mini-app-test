          ...
          <List className="!mb-48">
            ...
            <Section>
              <Modal
                ...
                className="h-full max-h-[calc(100%-1.5rem)]"
              >
            ...
            <Section>
              <Input
                ...
                {...register("areaFrom", {
                  ...
                  validate: (areaFrom) =>
                    validateFrom(areaFrom, getValues().areaTo),
                  onChange: () =>
                    compareRange(
                      "areaTo",
                      getValues().areaFrom,
              ...
              <Input
                ...
                {...register("areaTo", {
                  pattern: numberPattern,
                  validate: (areaTo) =>
                    validateTo(areaTo, getValues().areaFrom),
                  onChange: () =>
                    compareRange(
                      "areaFrom",
                      getValues().areaFrom,
            ...
            <Section>
              ...
              <Input
                ...
                {...register("priceFrom", {
                  pattern: numberPattern,
                  validate: (priceFrom) =>
                    validateFrom(priceFrom, getValues().priceTo),
                  onChange: () =>
                    compareRange(
                      "priceTo",
                      getValues().priceFrom,
              ...
              <Input
                ...
                {...register("priceTo", {
                  pattern: numberPattern,
                  validate: (priceTo) =>
                    validateTo(priceTo, getValues().priceFrom),
                  onChange: () =>
                    compareRange(
                      "priceFrom",
                      getValues().priceFrom,
