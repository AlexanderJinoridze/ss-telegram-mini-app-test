      ...
      <Fragment>
        ...
        <div className=" flex flex-col">
          <List className="!mb-48">
            ...
            <SectionFooter className="flex flex-col items-center">
              <div className="flex gap-6 mt-4 mb-6 justify-center">
                <a href="https://lemondo.com" target="_blank">
                  <svg
                    className="h-10"
                    viewBox="0 0 308 100"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      className="fill-[--tg-theme-hint-color] hover:fill-white/90"
                ...
                <a href="http://palitra.ge" target="_blank">
                  <svg
                    className="h-10"
                    viewBox="0 0 120 100"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <Subheadline level="1" className="text-[--tg-theme-hint-color]">
